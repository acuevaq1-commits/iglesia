...
if __name__ == '__main__':
    app.run(debug=True)
#--------------------------------------------------
# @app.route('/nueva-responsabilidad', methods=['POST'])
# def responsabilidad():
...
#     if fecha and dirigente and ujier and lectura:
#         cur = mysql.connection.cursor()
#         cur.callproc('sp_reg_responsabilidad', (fecha, dirigente, ujier, lectura, predicador, limpieza, santacena, comensales))        
#         # Si el procedimiento devuelve resultados
#         results = cur.fetchall()
#         cur.close()
#         if results:
#             flash("✔ Registro guardado satisfactoriamente.", "success")
#             return redirect(url_for('responsabilidades'))            
#         else:
...
#         cur = mysql.connection.cursor()
#         sql = "INSERT INTO usuario (name, surnames, email, password) VALUES (%s, %s, %s, %s)"
